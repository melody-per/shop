<template>
  <div>
    ...
    <el-card class="box-card">  
        <el-row :gutter="20">
        <el-col :span="8"><el-input placeholder="请输入内容" v-model="queryInfo.query" clearable @clear="getUserList"><el-button slot="append" icon="el-icon-search" @click="getUserList"></el-button>
        </el-input></el-col>
        <!-- 添加用户 -->
      ...
      <el-table-column width="180px" label="操作">
        <template v-slot="scoped">
          <!-- 编辑 -->
          <el-button size="mini" type="primary" icon="el-icon-edit" @click="getUserInfoById(scoped.row.id)"></el-button>
          <!-- 删除 -->
          <el-button size="mini" type="danger" icon="el-icon-delete" @click="delUserById(scoped.row.id)"></el-button>
          <!-- 修改 -->
          <el-tooltip class="item" effect="dark" content="用户修改" placement="top">
    ...
    <!-- 添加用户弹出框 -->
    <el-dialog title="添加用户" :visible.sync="addUserVisible" width="50%" @close="addFormClose">
       <!-- 添加用户表单 -->
    ...
    <!-- 修改用户弹出框 -->
     <el-dialog title="修改用户" :visible.sync="editUserVisible" width="50%" @close="editFormClose">
       <!-- 修改用户表单 -->
